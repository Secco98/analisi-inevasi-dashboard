...
# ========================= CONFIG =========================
st.set_page_config(page_title="Analisi Inevasi", layout="wide")

# placeholder messaggio avvio
startup_msg = st.empty()
startup_msg.markdown("### ⏳ Avvio dashboard…")
...
# BLOCCO TOTALE finché non c'è il file
if uploaded_file is None:
    st.info("⬅️ Carica un file per iniziare")
    st.stop()

# 👉 DA QUI LA DASHBOARD PARTE DAVVERO
startup_msg.empty()
